...
function Card({thumbnail , title , category , price , id ,reviews}) {
  ...
  return (
    <div className="group max-w-sm w-full bg-white rounded-2xl overflow-hidden border border-gray-200 shadow-md transition-all duration-500 ease-out hover:-translate-y-3 hover:scale-[1.02] hover:border-cyan-300 hover:shadow-[0_25px_60px_rgba(34,211,238,0.25)] hover:bg-gradient-to-br hover:from-white hover:to-cyan-50 cursor-pointer" onClick={() => navigate(`/viewcourse/${id}`)}>
